    ...
    while True:
        ...
        for i in np.random.permutation(np.arange(len(img_list))):
            ...
            if batch % batch_size == 0:
                ...
                train_label = np.array(y_label_batch)

                train_label1 = np.array(y_label_batch1)

                train_label2 = np.array(y_label_batch2)

                train_label3 = np.array(y_label_batch3)

                train_label4 = np.array(y_label_batch4)
