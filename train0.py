...
import argparse
import numpy as np
from net.model0 import Net
from config import Config
from data_loader0 import *
...
def train(args):
    EPOCHS = c.num_epochs
    filepath = "weights-{epoch:03d}-{val_l1_acc:.4f}.h5"
    ...
    model.compile(optimizer=adam, loss=['categorical_crossentropy' for _ in range(4)],
                  loss_weights=[10.0, 0.1, 0.1, 0.1], metrics=['accuracy'])
...
def args_parse():
    ...
    ap.add_argument("-m", "--model", type=str, default='checkpoint0',
