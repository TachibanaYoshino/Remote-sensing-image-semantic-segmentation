...
def train(args):
    ...
    plt.plot(np.arange(0, EPOCHS), H.history["l0_loss"], label="train_loss")
    ...
    plt.title("Training Loss and Accuracy on improved Unet")
    plt.xlabel("Epoch #")
...
def args_parse():
    ...
    ap.add_argument("-m", "--model", type=str, default='checkpoint6',
