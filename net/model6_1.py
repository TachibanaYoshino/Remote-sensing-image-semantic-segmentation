...
def Net(n_label,img_input):
    ...
    final_out = Activation('softmax',name='l0')(final_out)
    out1 = Activation('softmax',name='l1')(R_out4)
    out2 = Activation('softmax',name='l2')(R_out3)
    out3 = Activation('softmax',name='l3')(R_out2)
    out4 = Activation('softmax',name='l4')(R_out1)
